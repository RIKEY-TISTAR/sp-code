            ...
            <div className="w-full rounded-3xl px-16 py-12 bg-indigo-200 flex flex-col gap-10">
                ...
                <ul className="flex items-center gap-3">
                    <li className="inline-flex">
                        <Link href={'/articles/' + getData.slug} className='py-3 px-5 border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white transition-all font-semibold rounded-full'>Подробнее</Link>
                    </li>
                </ul>
            </div>
        </div>
